...
public class S3BinaryContentStorage implements BinaryContentStorage {
    ...
    public UUID put(UUID binaryContentId, byte[] bytes) {
        ...
        try {
            ...
            log.info(
                "[BINARYCONTENT_S3_SAVE_SUCCESS] S3 파일 저장 성공: binaryContentId={}, bucket={}, key={}",
                binaryContentId, props.getBucket(), key);
            return binaryContentId;
        } catch (S3Exception e) {
            log.error(
                "[BINARYCONTENT_S3_SAVE_FAIL] S3 파일 저장 실패: binaryContentId={}, bucket={}, key={}",
    ...
    public InputStream get(UUID binaryContentId) {
        ...
        try {
            ...
            log.info(
                "[BINARYCONTENT_S3_GET_SUCCESS] S3 파일 조회 성공: binaryContentId={}, bucket={}, key={}",
                binaryContentId, props.getBucket(), key);
            return inputStream;
        } catch (S3Exception e) {
            log.warn(
                "[BINARYCONTENT_S3_GET_FAIL] S3 파일 조회 실패: binaryContentId={}, bucket={}, key={}",
                binaryContentId, props.getBucket(), key, e);
            throw new BinaryContentException(
    ...
    public ResponseEntity<?> download(BinaryContentDto dto) {
        ...
        try {
            ...
            log.info(
                "[BINARYCONTENT_S3_DOWNLOAD_URL_SUCCESS] S3 presigned URL 생성 성공: binaryContentId={}, bucket={}, key={}",
            ...
            log.warn(
                "[BINARYCONTENT_S3_DOWNLOAD_URL_FAIL] S3 presigned URL 생성 실패: binaryContentId={}, bucket={}, key={}",
